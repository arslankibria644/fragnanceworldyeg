...
async function main() {
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      fragranceNotes: { top: ['Calabrian Bergamot', 'Pepper'], middle: ['Lavender', 'Pink Pepper', 'Vetiver', 'Patchouli', 'Geranium'], base: ['Ambroxan', 'Cedar', 'Labdanum'] },
      gender: 'MENS',
      images: ['https://images.unsplash.com/photo-1541643600914-78b084683702?w=800','https://images.unsplash.com/photo-1594035910387-fea47794261f?w=800'],
      basePrice: 12000,
      discount: 0,
      isFeatured: true,
      isNewArrival: false,
      ...
      variants: { create: [ { size: '60ml', price: 12000, stock: 25, sku: 'DIOR-SAU-60ML' }, { size: '100ml', price: 18000, stock: 15, sku: 'DIOR-SAU-100ML' }, { size: '200ml', price: 28000, stock: 8, sku: 'DIOR-SAU-200ML' } ] },
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      fragranceNotes: { top: ['Jasmine', 'Saffron'], middle: ['Amberwood', 'Ambergris'], base: ['Fir Resin', 'Cedar'] },
      gender: 'UNISEX',
      ...
      isNewArrival: true,
      isBestSeller: true,
      variants: { create: [ { size: '2ml', price: 1500, stock: 50, sku: 'MFK-BR540-2ML' }, { size: '5ml', price: 3000, stock: 30, sku: 'MFK-BR540-5ML' }, { size: '10ml', price: 5500, stock: 20, sku: 'MFK-BR540-10ML' }, { size: '15ml', price: 8000, stock: 15, sku: 'MFK-BR540-15ML' } ] },
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      fragranceNotes: { top: ['Pineapple', 'Bergamot', 'Black Currant', 'Apple'], middle: ['Birch', 'Patchouli', 'Rose', 'Jasmine'], base: ['Musk', 'Oak Moss', 'Ambergris', 'Vanilla'] },
      gender: 'MENS',
      ...
      isNewArrival: false,
      isBestSeller: true,
      variants: { create: [ { size: '50ml', price: 35000, stock: 10, sku: 'CREED-AV-50ML' }, { size: '100ml', price: 60000, stock: 5, sku: 'CREED-AV-100ML' } ] },
    },
  });
  ...
  await prisma.product.upsert({
    ...
    create: {
      ...
      fragranceNotes: { top: ['Cardamom', 'Chinese Pepper', 'Rosewood'], middle: ['Agarwood (Oud)', 'Sandalwood', 'Vetiver'], base: ['Tonka Bean', 'Amber', 'Musk'] },
      gender: 'UNISEX',
      ...
      isNewArrival: true,
      isBestSeller: false,
      variants: { create: [ { size: '50ml', price: 22000, stock: 12, sku: 'TF-OW-50ML' }, { size: '100ml', price: 38000, stock: 7, sku: 'TF-OW-100ML' } ] },
    },
  });
