...
export async function sendOrderConfirmationEmail(
  ...
  await transporter.sendMail({
    ...
    to,
    subject: `Order Confirmation - ${orderNumber} | Luxe Scents`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); padding: 30px; text-align: center;">
          <h1 style="color: #d4af37; font-size: 28px; margin: 0;">LUXE SCENTS</h1>
          <p style="color: #ccc; margin: 5px 0 0;">Premium Fragrances</p>
        </div>
        ...
        <div style="background: #1a1a1a; padding: 20px; text-align: center;">
          <p style="color: #888; margin: 0; font-size: 12px;">© 2024 Luxe Scents. All rights reserved.</p>
        </div>
      </div>
    `,
  });
